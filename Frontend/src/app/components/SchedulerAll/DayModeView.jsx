...
const StyledTableCell = styled(TableCell)(({ theme }) => ({
  ...
  [`&.${tableCellClasses.body}`]: {
    ...
    position: "relative", // Esto permitirá que los eventos se posicionen correctamente dentro de la celda
      ...
      return (
        <EventItem
          ...
          sx={{
            ...
            top: `${eventOffset}px`,
            position: "absolute", // Esto permitirá que el margen superior funcione correctamente
            width: "100%", // Asegúrate de que el evento ocupe todo el ancho de la celda
          }}
        />
      );
    });
