...
#Eventos
INSERT INTO EVENTO_CONTENEDOR (`PK_evento_contenedor`,`nombre`,`descripcion`,`lugar`,`dia_inicio`,`dia_final`,`activo`,`FK_tipo_evento`,`direccion`) VALUES (1,'XXIV International Symposium of Mathematical Methods Applied to Sciences','The XXIV International Symposium of Mathematical Methods Applied to Sciences (XXIV SIMMAC) is the most important applied mathematics event in Central America. It is organized by the Center for Research in Pure and Applied Mathematics (CIMPA) of the University of Costa Rica (UCR) every two years, with the collaboration of the School of Mathematics (EMat).','Guanacaste Campus, Liberia, University of Costa Rica (UCR).','2024-02-20','2024-02-24',1,1,'https://maps.app.goo.gl/hdRSXbrVePDHhWoy8');
INSERT INTO EVENTO_CONTENEDOR (`PK_evento_contenedor`,`nombre`,`descripcion`,`lugar`,`dia_inicio`,`dia_final`,`activo`,`FK_tipo_evento`,`direccion`) VALUES (2,'18th International Federation of Classification Societies','The International Federation of Classification Societies (IFCS) groups the national or regional classification societies all around the world. The IFCS organizes an international conference every two years since 1987.\n\nThe 18th conference of the International Federation of Classification Societies will take place in San José, Costa Rica, on 15-29 July 2024.\n\nFor 2024, the University of Costa Rica has been chosen to host the IFCS Conference, that will be organized by the Central American and Caribbean Society for Classification and Data Analysis (SoCCCAD).',' .','2024-07-15','2024-07-19',1,2,'https://maps.app.goo.gl/W2FWev3LKMzYYSh26');
