...
describe("Pruebas para el enrutador de usuarios", () => {
  ...
  it("debe responder con los usuarios en una solicitud GET /usuarios/all", async () => {
    ...
    expect(response.body).toEqual([
      ...
      },
      {
          ...
          "genero": "H",
          "nombre_documentos": null,
          "afiliacion": "Instituto de Matematicas, Universidad Nacional Autonoma de Mexico",
      ...
      },
      {
          ...
          "tipo_id": null,
          "cedula": null,
          "password": "$2a$12$S8uiC/vjIE3b/s3zyy7f6OyD4j3Z/FbaQQlrRKiZbzFtWuxGg5Dwe",
  ...
  it("debe responder con un usuario por ID en una solicitud POST /usuarios/usuario", async () => {
    const cedula = '22222222'; // Ajusta el ID del usuario que deseas buscar
  ...
  it("debe responder correctamente a una solicitud POST /usuarios/login con contraseña correcta", async () => {
    const userCedula = '111111111'; // Ajusta el ID del usuario que deseas autenticar
  ...
  it("debe responder con un error en una solicitud POST /usuarios/login con contraseña incorrecta", async () => {
    const cedula = '22222222'; // Ajusta el ID del usuario que deseas autenticar
